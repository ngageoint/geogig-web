...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/FeatureFilter', 'model/SRS'], factory);
   ...
   * @module model/FeatureQuery
   * @version 0.1-SNAPSHOT
   */

  /**
   * Constructs a new <code>FeatureQuery</code>.
   * @alias module:model/FeatureQuery
   * @class
   */
   ...
   * @param {module:model/FeatureQuery} obj Optional instance to populate.
   * @return {module:model/FeatureQuery} The populated <code>FeatureQuery</code> instance.
   */
  ...
  /**
   * @member {module:model/FeatureQuery.ResultTypeEnum} resultType
   */
  exports.prototype['resultType'] = undefined;
  /**
   * @member {module:model/SRS} outputCrs
   */
