...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BoundingBox', 'model/RevisionFeatureType'], factory);
   ...
   * @param {module:model/LayerInfo} obj Optional instance to populate.
   * @return {module:model/LayerInfo} The populated <code>LayerInfo</code> instance.
   */
  ...
  /**
   * @member {module:model/RevisionFeatureType} type
   */
