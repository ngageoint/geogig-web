...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/RepoLayerSummary'], factory);
   ...
   * @alias module:model/UserLayerSummary
   * @class
   */
   ...
   * @param {module:model/UserLayerSummary} obj Optional instance to populate.
   * @return {module:model/UserLayerSummary} The populated <code>UserLayerSummary</code> instance.
   */
  ...
  /**
   * @member {Array.<module:model/RepoLayerSummary>} repositories
   */
