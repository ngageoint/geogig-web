...
(function(root, factory) {
   ...
   * @module model/TreeBucket
   * @version 0.1-SNAPSHOT
   */

  /**
   * Constructs a new <code>TreeBucket</code>.
   * @alias module:model/TreeBucket
   * @class
   */
   ...
   * @param {module:model/TreeBucket} obj Optional instance to populate.
   * @return {module:model/TreeBucket} The populated <code>TreeBucket</code> instance.
   */
