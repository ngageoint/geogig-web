...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Geogig.TreeBucket();
  });
  ...
  describe('TreeBucket', function() {
    it('should create an instance of TreeBucket', function() {
      // uncomment below and update the code to test TreeBucket
      //var instane = new Geogig.TreeBucket();
      //expect(instance).to.be.a(Geogig.TreeBucket);
    });
