...
(function(root, factory) {
  ...
  describe('StoreInfo', function() {
    it('should create an instance of StoreInfo', function() {
      // uncomment below and update the code to test StoreInfo
      //var instane = new Geogig.StoreInfo();
      //expect(instance).to.be.a(Geogig.StoreInfo);
    });
